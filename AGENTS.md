...
```xml
<opml version="2.0" xmlns:fw="https://github.com/r-Kai-dev/FengWen">
  <body>
...
- `fw:type="created"` — feeds generated by Feng Wen, hosted on GitHub
- `fw:type="official"` — external RSS/Atom feeds
- Raw feeds base: `https://raw.githubusercontent.com/r-Kai-dev/FengWen/refs/heads/main/feeds`
